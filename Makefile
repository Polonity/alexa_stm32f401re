...
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/TOOLCHAIN_GCC_ARM/startup_stm32f401xe.o
...
OBJECTS += ./shields/TARGET_CORDIO_BLUENRG/BlueNrgHCIDriver.o
...
INCLUDE_PATHS += -I.././shields/TARGET_CORDIO_BLUENRG
INCLUDE_PATHS += -I.././source
INCLUDE_PATHS += -I../C:/Users/hiken/workspace/devel/nucleo/mbed-cli/BLE/BLE_GattServer/mbed-os

LIBRARY_PATHS :=
LIBRARIES :=
LINKER_SCRIPT ?= .././mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/TOOLCHAIN_GCC_ARM/STM32F401XE.ld
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1587132576.7710826
C_FLAGS += -DDEVICE_LPTICKER=1
C_FLAGS += -DTARGET_FF_ARDUINO
C_FLAGS += -DTARGET_RTOS_M4_M7
C_FLAGS += -DSTM32F401xE
...
C_FLAGS += -DTARGET_CORDIO_BLUENRG
C_FLAGS += -include
C_FLAGS += mbed_config.h
C_FLAGS += -c
C_FLAGS += -g3
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1587132576.7710826
CXX_FLAGS += -DDEVICE_LPTICKER=1
CXX_FLAGS += -DTARGET_FF_ARDUINO
CXX_FLAGS += -DTARGET_RTOS_M4_M7
CXX_FLAGS += -DSTM32F401xE
...
CXX_FLAGS += -DTARGET_CORDIO_BLUENRG
CXX_FLAGS += -include
CXX_FLAGS += mbed_config.h
CXX_FLAGS += -c
CXX_FLAGS += -g3
...
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F4\TARGET_STM32F401xE
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F4\TARGET_STM32F401xE\TARGET_NUCLEO_F401RE
ASM_FLAGS += -I..\shields\TARGET_CORDIO_BLUENRG
ASM_FLAGS += -I..\source
ASM_FLAGS += -IC:\Users\hiken\workspace\devel\nucleo\mbed-cli\BLE\BLE_GattServer\mbed-os
ASM_FLAGS += -include
